...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "AccountService@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "AccountService API";

        private String description = "AccountService API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "AccountService";
